...
@Repository
public class InvoiceSalahService {
    @Autowired
    private DataSource dataSource;

    private JdbcTemplate getJdbcTemplate(){return new JdbcTemplate(dataSource);}

    public List<Map<String, Object>> getInvoiceSalahList(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir, String pBank, String pCurrency, String pCaraBayar, String pUserId, String sortBy, String sortDir, String status, String statusTracking, String pSearch){
        List<Map<String, Object>> dataset  = new ArrayList<>();
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("invoice_get_gagal");
        ...
        AppUtils.getLogger(this).info("invoice_get_gagal_param : {}",params);
        try{
           dataset  = (List<Map<String, Object>>) simpleJdbcCall.executeFunction(ArrayList.class,params);
           AppUtils.getLogger(this).info("invoice_get_gagal : {}",dataset);
        }catch (Exception e){
            e.printStackTrace();
        }
        return dataset;
    ...
    public List<Map<String, Object>> getAllXlsInvoiceSalah() throws SQLException {
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("get_all_invoice_gagal");
    ...
    public Map<String, Object> reverseGagalToSap(String comp_code, String doc_no,  String fiscal_year, String line_item, String ket, String user_id, String oss_id, String group_id){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("invoice_reverse_gagal_to_sap");
        SqlParameterSource param = new MapSqlParameterSource()
                .addValue("p_comp_code", comp_code, Types.VARCHAR)
                .addValue("p_doc_no", doc_no,Types.VARCHAR)
                .addValue("p_fisc_year", fiscal_year,Types.VARCHAR)
                .addValue("p_line_item", line_item,Types.VARCHAR)
                .addValue("p_ket", ket,Types.VARCHAR)
                .addValue("p_user_id", user_id,Types.VARCHAR)
                .addValue("p_oss_id", oss_id,Types.VARCHAR)
                .addValue("p_group_id", group_id,Types.VARCHAR)
                .addValue("out_msg",Types.VARCHAR);
        Map<String, Object> dataset = simpleJdbcCall.execute(param);
        AppUtils.getLogger(this).info("reverse_invoice_gagal_to_sap : {}",dataset);
        return dataset;
    }
}
