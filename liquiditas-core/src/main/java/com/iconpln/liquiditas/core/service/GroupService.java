...
public class GroupService {
    ...
    public List<Map<String, Object>> getListGroupInvoice(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,String pUserId, String sortBy, String sortDir, String pSearch) throws SQLException {
        ...
        AppUtils.getLogger(this).debug("data rekap search info = " +
                ...
                pStart, pLength, pTglAwal, pTglAkhir, pUserId, sortBy, sortDir, pSearch);

        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("group_get");
    ...
    public Map<String, Object> cancelGroup(String pCompCode, String pDocNo, String pFiscYear, String pLineItem, String pKet, String pNamaGroup, String pUserId) throws SQLException {
