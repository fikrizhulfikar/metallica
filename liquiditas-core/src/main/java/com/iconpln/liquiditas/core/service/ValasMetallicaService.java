 ...
 */
@Repository
public class ValasMetallicaService {
    ...
    public List<Map<String, Object>> getListPembelianValas(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                ...
                .withFunctionName("pembelian_valas_get");
        ...
        AppUtils.getLogger(this).info("data pembelian_valas_get : {}", resultset);
...
//    }
    ...
    public List<Map<String, Object>> getColumn(String userId) throws SQLException {
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pembelian_valas_get_column");
        Map<String, Object> params = new HashMap<>();
