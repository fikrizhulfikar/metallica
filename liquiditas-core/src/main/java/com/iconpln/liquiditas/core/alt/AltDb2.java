...
public class AltDb2 {
    private static final String TAG = AltDb2.class.getName();
    public static Map<String, AltDb2> instances = new HashMap<>();
    ...
    public AltDb2(String db_instance){
    ...
    public AltDb2(Map<String, String> config){
        this.config = config;
    }

    public static AltDb2 instance(){
        return AltDb2.instance("default");
    }

    public static AltDb2 instance(String db_instance){
        AltDb2.instances.putIfAbsent(db_instance, new AltDb2(db_instance));

        return AltDb2.instances.get(db_instance);
    }
