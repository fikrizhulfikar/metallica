...
@Repository
public class PindahBukuTrxService {
    ...
    public List<Map<String, Object>> getListPindahBukuTrx(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                ...
                .withFunctionName("pindahbuku_head_trx_get");
        ...
        AppUtils.getLogger(this).info("data pindah_buku_trx_get : {}", resultset);
//        System.out.println("Pembelian Valas Metallica : "+resultset);
    ...
    public Map<String, Object> insPindahBuku(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_head_trx_ins");
    ...
    public List<Map<String, Object>> getDetails(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_item_trx_get");
        ...
        AppUtils.getLogger(this).info("data pindah_buku_item_trx_get : {}", resultset);
//        System.out.println("Pembelian Valas Metallica : "+resultset);
        return resultset;
    }
    ...
    public Map<String, Object> insDetailPindahBukuTrx(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_item_trx_ins");
        Map<String, Object> out;
    ...
    public Map<String, Object> deletePindahBukuTrxHead(String pIdMetallica){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_head_trx_del");

        SqlParameterSource param = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica);

        Map<String, Object> result = simpleJdbcCall.execute(param);
        AppUtils.getLogger(this).info("param delete_pindah_buku_trx_head : {}",result);
        return result;
    }
    ...
    public Map<String, Object> updateStatus(String pIdMetallica, String pStatusTracking){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_trx_verifikasi");
        Map<String, Object> out;
        SqlParameterSource inParent = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica)
    ...
    public Map<String, Object> updateReverse(String pIdMetallica, String pStatusTracking){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_trx_reverse");
        SqlParameterSource param = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica)
                .addValue("p_status_tracking", pStatusTracking)
                .addValue("out_msg", OracleTypes.VARCHAR);
        Map<String, Object> result = simpleJdbcCall.execute(param);
        AppUtils.getLogger(this).info("data pindah_buku_trx_reverse : {}", result);
        return result;
    }

    public List<Map<String, Object>> getListPindahBukuTrxVerified(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
                                                                      String pCurrency, String pUserId, String sortBy,
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_head_verified_get");
...
//        System.out.println("Pembelian Valas Metallica : "+resultset);
    ...
    public List<Map<String, Object>> getListPindahBukuTrxLunas(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
                                                                   String pCurrency, String pUserId, String sortBy,
                                                                   String sortDir, String status, String statusTracking, String pSearch
    ) throws SQLException {
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("pindahbuku_head_lunas_get");
