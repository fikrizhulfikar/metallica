...
@Repository
public class PembelianValasTrxService {
    ...
    public List<Map<String, Object>> getListPembelianValasTrx(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                ...
                .withFunctionName("valas_head_trx_get");
...
//        System.out.println("Pembelian Valas Metallica : "+resultset);
    ...
    public Map<String, Object> insPembelian(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_head_trx_ins");
    ...
    public List<Map<String, Object>> getDetails(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_item_trx_get");
...
//        System.out.println("Pembelian Valas Metallica : "+resultset);
    ...
    public Map<String, Object> insDetailPembelianValasTrx(
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_item_trx_ins");
        Map<String, Object> out;
        ...
        AppUtils.getLogger(this).info("get ins_detail_valas_trx : {}", out);
        return out;
    }
    ...
    public Map<String, Object> deletePembelianValasTrxHead (String pIdMetallica){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_head_trx_del");
        SqlParameterSource param = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica);

        Map<String, Object> result = simpleJdbcCall.execute(param);
        AppUtils.getLogger(this).info("data delete_pembelian_valas_trx_head : {}",result);
        return result;
    }
    ...
    public Map<String, Object> updateStatus(String pIdMetallica, String pStatusTracking){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_trx_verifikasi");
        Map<String, Object> out;
        SqlParameterSource inParent = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica)
    ...
    public Map<String, Object> updateReverse(String pIdMetallica, String pStatusTracking){
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_trx_reverse");
        SqlParameterSource param = new MapSqlParameterSource()
                .addValue("p_id_metallica", pIdMetallica)
                .addValue("p_status_tracking", pStatusTracking)
                .addValue("out_msg", OracleTypes.VARCHAR);
    ...
    public List<Map<String, Object>> getListPembelianValasTrxVerified(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
                                                              String pCurrency, String pUserId, String sortBy,
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_head_verified_get");
        ...
        AppUtils.getLogger(this).info("data pembelian_valas_trx_verified_get : {}", resultset);
//        System.out.println("Pembelian Valas Metallica : "+resultset);
        return resultset;
    }

    public List<Map<String, Object>> getListPembelianValasTrxLunas(Integer pStart, Integer pLength, String pTglAwal, String pTglAkhir,
                                                                      String pCurrency, String pUserId, String sortBy,
                                                                      String sortDir, String status, String statusTracking, String pSearch
    ) throws SQLException {
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("valas_head_lunas_get");
...
//        System.out.println("Pembelian Valas Metallica : "+resultset);
    ...
    public BigDecimal getTotalTagihan(String tglAwal,
        ...
        BigDecimal result = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("pkg_corpay")
                .withFunctionName("get_total_tagihan_valas")
    ...
    public BigDecimal getTotalTagihanLunas(String tglAwal,
        ...
        BigDecimal result = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("pkg_corpay")
                .withFunctionName("get_total_valas_lunas")
                .executeFunction(BigDecimal.class, in);
        return result;
    }
    ...
    public List<Map<String, Object>> getAllpembayaran(String idUser, String pTglAwal, String pTglAkhir,  String pCurr) throws SQLException {
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("get_all_valas_by_status");
    ...
    public List<Map<String, Object>> getAllpembayaran2(String idUser, String pTglAwal, String pTglAkhir,  String pCurr) throws SQLException {
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("get_all_valas_by_status2");
    ...
    public List<Map<String, Object>> getAllpembayaran3(String idUser, String pTglAwal, String pTglAkhir,  String pCurr) throws SQLException {
        ...
        SimpleJdbcCall simpleJdbcCall = new SimpleJdbcCall(getJdbcTemplate())
                .withCatalogName("PKG_CORPAY")
                .withFunctionName("get_all_valas_by_status3");
