...
function exportXls() {
    ...
    window.open(baseUrl + "api_invoice_pilot/hrap_invoice/xls/oss/" + tglAwal.replaceAll("/","-") + "/" + tglAkhir.replaceAll("/","-") + "/" + $("#cmb_bank").val() + "/" + $("#cmb_currecny").val()  );
}
            ...
            table_rekapitulasi = $('#table-rekapitulasi').DataTable({
                    ...
                    "aoColumnDefs": [
                        ...
                        },
                        {
                            ...
                            "name" : "DOC_DATE",
                            "mRender": function (data, type, full) {
                                return moment(full.DOC_DATE).format("DD/MM/YYYY");
                            }
                        ...
                        },
                        {
                            ...
                            "name" : "POST_DATE",
                            "mRender": function (data, type, full) {
                                return moment(full.POST_DATE).format("DD/MM/YYYY");
                            }
                        ...
                        },
                        {
                            ...
                            "name" : "ENTRY_DATE",
                            "mRender": function (data, type, full) {
                                return moment(full.ENTRY_DATE).format("DD/MM/YYYY");
                            }
                        ...
                        },
                        {
                            ...
                            "name" : "EXCH_RATE",
                            "mRender": function (data, type, full) {
                                return parseFloat(full.EXCH_RATE.toString()).toString() ;
                            }
                    ...
                    "ajax":
                        {
                            "url":
                                baseUrl + "api_invoice_pilot/hrap_invoice/list_invoice_oss",
                            "type":
                                "GET",
                            "dataType":
                                "json",
