...
function initDataTable(pTglAwal, pTglAkhir, pBank, pCurrency, pPembayaran) {
    ...
    $('.dataTables_filter').each(function () {
        if(newRoleUser[0] == "ROLE_OSS"){
            $(this).append('<button class="btn-delete btn-danger btn-sm" id="btn-verified" style="margin-left: 10px" type="button" onclick="multipleDelete()"><i class="fa fa-close"></i></button>');
        }
        else{
