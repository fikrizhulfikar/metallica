...
function getAllData() {
    $.ajax({
        url: baseUrl + "api_operator/rekap_invoice_belum/get_invoice_lcl",
        dataType: 'JSON',
        type: "GET",
        data: {
            pStatusValas: "0",
...
//                        },
                            ...
                            "mRender": function (data, type, full) {
                                ...
                                if (newRoleUser[0] == "ROLE_MS_LIKUIDITAS" || newRoleUser[0] == "ROLE_DM_LIKUIDITAS") {
                                    ...
                                    if (full.STATUS_TRACKING == "INPUT DATA") {
                                        ...
                                        ret_value =
                                            '<div class="btn-group">';
                                         if(newRoleUser[0] == "ROLE_LOCAL_CURRENCY_LIQUIDITY"){
                                           ret_value = ret_value +
                    ...
                    "ajax":
                        {
                            "url":
                                baseUrl + "api_operator/rekap_invoice_belum/get_invoice_lcl",
                            "type":
                                "GET",
                            "dataType":
                                "json",
...
function update_pembayaran() {
    showLoadingCss()
    $.ajax({
        url: baseUrl + "api_operator/rekap_invoice_belum/update_house_bank",
        dataType: 'JSON',
        type: "POST",
        data: {
