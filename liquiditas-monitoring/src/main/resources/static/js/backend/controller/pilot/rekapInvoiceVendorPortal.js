...
function exportXls() {
    ...
    window.open(baseUrl + "api_invoice_pilot/hrap_invoice/xls/vip/" + moment(tglAwal).format("YYYYMMDD") + "/" + moment(tglAkhir).format("YYYYMMDD") + "/" + $("#cmb_bank").val() + "/" + $("#cmb_currecny").val());
}
