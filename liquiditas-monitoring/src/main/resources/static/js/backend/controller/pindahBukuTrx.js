...
function initDataTable(pTglAwal, pTglAkhir,  pCurrency, statusTracking) {
                            ...
                            if (full.STATUS_TRACKING === "INPUT DATA") {
                                ...
                                if(newRoleUser[0] == "ROLE_VP_LIQUIDITY_AND_RECEIPT"){
                                    ret_value = ret_value +
                                        ...
                                        '<button style="width: 15px !important;margin-right: 5px !important;" class="btn btn-sm btn-primary" title="Pelunasan" onclick="updateLunas(\'' +full.ID_METALLICA+'\',\''+jenis+'\')"><i class="fa fa-credit-card-alt"></i></button>'+
                                        '</div>';
                                }
                                if(newRoleUser[0] == "ROLE_ADMIN"){
                                    ret_value = ret_value +
    ...
    $('.dataTables_filter').each(function () {
       ...
       if(newRoleUser[0] == "ROLE_JA_CASH" || newRoleUser[0] == "ROLE_JA_IE" ) {
        html = html + '<button class="btn btn-delete btn-danger btn-sm" id="btn-verified" style="margin-left: 10px; width: 32px !important;" type="button" title="Delete Data" onclick="multipleDelete()"><i class="fa fa-close"></i></button>';
       }
       if(newRoleUser[0] == "ROLE_VP_LIQUIDITY_AND_RECEIPT" || newRoleUser[0] == "ROLE_VP_INVESTMENT_EXPENDITURE"
           ...
           || newRoleUser[0] == "ROLE_VP_OPERATION_EXPENDITURE") {
            html = html +'<button class="btn btn-edit-data btn-sm btn-primary" style="margin-left: 10px" type="button" title="Pelunasan" onclick="multi_upd_lunas()"><i class="fa fa-credit-card-alt"></i></button>';
       }
       if(newRoleUser[0] === 'ROLE_ADMIN'){
           html = html + '<button class="btn btn-delete btn-danger btn-sm" id="btn-verified" style="margin-left: 10px; width: 32px !important;" type="button" title="Delete Data" onclick="multipleDelete()"><i class="fa fa-close"></i></button>'+
                '<button class="btn btn-edit-data btn-sm btn-primary" style="margin-left: 10px; width: 32px !important;" type="button" title="Pelunasan" onclick="multi_upd_lunas()"><i class="fa fa-credit-card-alt"></i></button>';
       }
       $(this).append(html);
    });
