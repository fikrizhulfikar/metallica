    ...
    tblpindahBukuDetail = $("#table-main-detail").DataTable({
        ...
        "columns" : [
            ...
            },
            {
                ...
                "render" : (data) => {
                    if(data.FLAG == 1){
                        return '<td align="center"> <button class="btn btn-sm btn-danger" onclick="deletedb(\'' +data.ID_METALLICA+'\',\'' +data.ID_PINDAHBUKU_ITEM_TRX+ '\')"><i class="fa fa-trash"></i></button></td>';
                    }else if(data.FLAG == 0){
