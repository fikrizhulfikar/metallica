                            ...
                            if (full.STATUS_TRACKING === "INPUT DATA") {
                                ...
                                if(newRoleUser[0] === "ROLE_ADMIN" && full.TOTAL_TAGIHAN !== "-"){
                                    ...
                                    ret_value = ret_value +
                                        ...
                                        '<button type="button" style="width: 15px !important; margin-right: 5px !important;" class="btn btn-edit-data btn-sm btn-info" title="Edit Data" onclick="edit_data(\'' +full.ID_METALLICA+'\')"><i class="far fa-edit"></i></button>'+
                                        '<button type="button" style="width: 15px !important; margin-right: 5px !important;" class="btn btn-edit-data btn-sm btn-warning" title="Verified MAKER" onclick="update_status(\'' +full.ID_METALLICA+'\',\''+1+'\',\''+full.AMOUNT_DEBIT+'\',\''+full.AMOUNT_CREDIT+'\')"><i class="fa fa-arrows-alt"></i></button>'+
                                        '<button type="button" style="width: 15px !important;" class="btn btn-update-data btn-sm btn-danger" title="Hapus" onclick="deleteHead(\'' + full.ID_METALLICA + '\')"><i class="fas fa-trash"></i></button>'+
                                        '</div>';
                                }
                                ...
                                if(newRoleUser[0] === "ROLE_VP_LIQUIDITY_AND_RECEIPT"){
                                    ret_value = ret_value +
                                        ...
                                        '<button style="width: 15px !important; margin-right: 5px !importatnt" class="btn btn-edit-data btn-sm btn-primary" title="Pelunasan" onclick="updateLunas(\'' +full.ID_METALLICA+'\',\''+jenis+'\')"><i class="fas fa-credit-card"></i></button>'+
                                        '</div>';
                                }
                                if(newRoleUser[0] === "ROLE_ADMIN"){
                                    ret_value = ret_value +
...
//         console.log("ROLE : ",newRoleUser[0]);
        var html = '<button class="btn btn-warning btn-sm" id="btn-verified" style="margin-left: 10px; width: 32px !important;" type="button" title="Update Data" onclick="update_datas()"><i class="fa fa-arrows-alt"></i></button>' ;
              ...
              html = html +'<button class="btn btn-sm btn-primary" style="margin-left: 10px; width: 32px !important;" type="button" title="Pelunasan" onclick="multi_upd_lunas()"><i class="fas fa-credit-card"></i></button>';
              }
              $(this).append(html);
    });
