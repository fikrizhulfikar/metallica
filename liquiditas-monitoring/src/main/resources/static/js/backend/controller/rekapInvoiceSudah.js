...
function getAllData() {
    $.ajax({
        url: baseUrl + "api_operator/rekap_invoice_sudah/get_rekap_invoice",
        dataType: 'JSON',
        type: "GET",
        data: {
            pStatusValas: "0",
...
function update_pembayaran() {
    showLoadingCss()
    $.ajax({
        url: baseUrl + "api_operator/rekap_invoice_sudah/update_pembayaran",
        dataType: 'JSON',
        type: "POST",
        data: {
...
function update_status(pCompCode, pDocNo, pFiscYear, pLineItem, pKet, pStatusTracking, pCustomerName, pAccountNumber){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/update_status",
            dataType: 'JSON',
            type: "POST",
            data: {
                 pCompCode: pCompCode,
...
function getBallance2(pBank, pSource, pBeneficiary){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/get_Ballance2",
            dataType: 'JSON',
            type: "POST",
            data: {
                 pBank: $("#pBanks").val(),
...
function getInquiry(pSource, pBank,  pBeneficiaryAccount){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/inquiry",
            dataType: 'JSON',
            type: "POST",
            data: {
...
function updLunas(pStatus){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/update_lunas",
            dataType: 'JSON',
            type: "POST",
            data: {
...
function doPayment(pMetodeBayar, pBank, pRefNum, pSource, pBeneficiaryAccount, pCurrency,
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/do_payment",
            dataType: 'JSON',
            type: "POST",
            data: {
...
function reverse_status(pCompCode, pDocNo, pFiscYear, pLineItem, pKet, pStatusTracking){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/reverse_status",
            dataType: 'JSON',
            type: "POST",
            data: {
                 pCompCode: pCompCode,
...
function reject_data(pCompCode, pDocNo, pFiscYear, pLineItem, pKet){
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/ins_rekap_reject",
            dataType: 'JSON',
            type: "POST",
            data: {
                 pCompCode: pCompCode,
...
function create_group() {
    ...
    if (stateCrf == true) {
        showLoadingCss();
        $.ajax({
            url: baseUrl + "api_operator/rekap_invoice_sudah/create_group",
            dataType: 'JSON',
            type: "POST",
            data: {
