    ...
    tablePembelianValas = $('#table-rekapitulasi').DataTable({
            ...
            "aoColumnDefs": [
                ...
                },
                {
                    "aTargets": [10],
                    "mRender": function (data, type, full) {
                        return accounting.formatNumber(full.EXCHANGE_RATE,2,".",",");
                    }
                ...
                },
                {
                    "aTargets": [11],
                    "mRender": function (data, type, full) {
                        return (isNaN(full.TOTAL_TAGIHAN)) ? "-" : accounting.formatNumber(full.TOTAL_TAGIHAN,2,".",",");
                    }
                },
                {
                    "aTargets": [12],
            ...
            "ajax":
                {
                    "url":
                        baseUrl + "api_operator/pembelian_valas_trx/get_pembelian_valas_trx",
                    "type":
                        "GET",
                    "dataType":
                        "json",
            ...
            },
            {
                ...
                "render" : (data) => {
                    if(data.FLAG == 1 || track == "INPUT_DATA"){
                        return '<td align="center"> <button class="btn btn-sm btn-danger" onclick="deletedb(\'' +data.ID_METALLICA+'\',\'' +data.ID_VALAS_ITEM_TRX+ '\',\'' +data.LINE_NO+ '\')"><i class="fa fa-trash"></i></button></td>';
                    }else if(data.FLAG == 0){
