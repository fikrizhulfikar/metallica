...
function initDataTable() {
    ...
    tableMain = $('#table-main').DataTable({
        "ajax": {
            "url": baseUrl + "api_master/customer/get_list_customer",
            "type": "GET",
            "dataType": "json",
        },
        "columns": [
            ...
            {"data": "COUNTRY"},
            {"data": "CUSTOMER_EMAIL"},
            {"data": "CUSTOMER_MGMT_GRP"},
            {"data": "CUSTOMER_NAME"},
            {"data": "CUSTOMER_NO"},
            {"data": "CUSTOMER_PMT_METHOD"},
            {"data": "CUSTOMER_PMT_TERM"},
            {"data": "CUSTOMER_RECON_ACCT"},
            {"data": "CUSTOMER_TAX_NO"},
            {"data": "CUSTOMER_VAT_NO"},
            {"data": "CUST_ACC_GRP"},
            {"data": "PERSONNEL_NO"},
            {"data": "POSTAL_CODE"},
            {"data": "STREET_NO"},
