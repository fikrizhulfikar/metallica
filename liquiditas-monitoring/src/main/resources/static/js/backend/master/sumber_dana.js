...
function upload_server_xls() {
    ...
    formData.append('pIdJenisFile', "6");
        ...
        success: function (res) {
            ...
            if (res.V_RETURN == 0) {
               ...
               location.reload();
                ...
                window.location = "../api_master/download/6/"+obj["ID_UPLOAD"];
            }
        },
        error: function () {
            hideLoadingCss("Gagal Melakukan Proses,Harap Hubungi Administrator");
        ...
        "aoColumnDefs": [
            ...
            ,
            {
                ...
                "mRender": function (data, type, full) {
                    ...
                    var ret_value =
                        '<button style="width: 15px !important;" class="btn btn-info" title="Edit Data" onclick="getbyId(\'' + full.ID_SUMBER_DANA + '\')"><i class="fas fa-edit"></i></button>'
                    return ret_value;
